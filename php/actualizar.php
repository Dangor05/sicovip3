...
$dir ='C:\apache\htdocs\SICOVIP\archivos/'.$sv03cedp.'/';
		include "conexion.php";
			...
			$sql = "UPDATE sv09vsdo SET sv09nfol='$sv09nfol',sv09npre='$sv09npre',sv09mnt='".$sv09mnt['name']."',sv09fvdp='$sv09fvdp',sv09fumv=NOW(),sv08conse='$sv08conse',sv01cedc='$sv01cedc',sv03cedp='$sv03cedp',sv04nfin='$sv04nfin',sv02code='$sv02code',sv07cdtp='$sv07cdtp' WHERE sv09npln='$sv09npln'";
